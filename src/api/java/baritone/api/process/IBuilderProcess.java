...
public interface IBuilderProcess extends IBaritoneProcess {
    ...
    /**
     * Start building the currently selected (or first enabled) Litematica placement.
     * Origin is taken from the placement (absolute world coordinates, rotation/mirror applied).
     * Player position is never used as origin.
     *
     * @return true if a placement was found and build started
     */
    boolean buildActiveLitematic();

    /**
     * Toggle AutoBuild: start if idle, stop if currently building.
     */
